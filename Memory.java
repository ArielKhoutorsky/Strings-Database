...
import java.util.LinkedList;
    ...
    public class Memory{
        ...
        public String get(int id) { // returns the string associated with the id //
            int counter = 0;
            int strDSta = 0;
            int strDLen = 0;
        ...
        public int get(String s) { // returns the id associated with the string //
        ...
        public int remove(String s) { // removes the string and returns the id of that string //
        ...
        public String remove(int id) { // removes the string associated with the given id and returns that string //
        ...
        public void defragment() { // removes all the wholes in the array to make space for newly stores strings //
        ...
        public int put(String s) { // stores the string in the array and assigns to it a length, a unique id and a starting id //
